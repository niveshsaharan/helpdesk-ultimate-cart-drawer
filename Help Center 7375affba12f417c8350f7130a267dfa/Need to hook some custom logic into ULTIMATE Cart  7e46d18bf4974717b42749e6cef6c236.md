# Need to hook some custom logic into ULTIMATE Cart Drawer?

ULTIMATE Cart Drawer is designed to be a developer friendly app and It has various hooks/filters you can use to push your custom logic to suit your needs.

We advise you to create a new file `sellify-ucd-filters.liquid` in your [Shopify Theme](https://shopify.com/admin/themes/current) and include between the `<head></head>` section  in [theme.liquid](https://shopify.com/admin/themes/current?key=layout%2Ftheme.liquid)
...
1. raw_cart
    ...
    It can be used to modify original Cart JSON object which is loaded from AJAX API and used to build the cart drawer data.

    ```jsx
    sellify.ucd.filters.raw_cart.push(function(cart){
    	
    	// Modify cart data if need and return modified object
    	return cart;
    });
    ```

    - Toggle `cart` argument data
...
2. product
    ...
    Each product in suggestions is passed into this filter and you can use it to modify the product data.

    ```jsx
    sellify.ucd.filters.product.push(function(product){
    	return product;
    });
    ```

    - Toggle `product` argument data
...
3. cart
    ...
    Modified cart object after applying your custom `raw_cart` filters and other modification by core.
    ...
    - Toggle `cart` argument data
        ...
        ```json
        {
          ...
          "note": null,
          "attributes": {},
          "original_total_price": 329700,
          "total_price": 258900,
          "total_discount": 70800,
          "total_weight": 28349.9767,
          "item_count": 2,
          "items": [
            {
              "id": 12543438454867,
              "properties": {
                "__ucd": "Tiered Free Items"
              },
              "quantity": 1,
              "variant_id": 12543438454867,
              "key": "12543438454867:b2471fcc27892a94facddcad853ebdc5",
              "title": "Club Ride Roxbury Jersey - S",
              "price": 70800,
              "original_price": 70800,
              "discounted_price": 0,
              "line_price": 0,
              "original_line_price": 70800,
              "total_discount": 70800,
              "discounts": [
                {
                  "amount": 70800,
                  "title": "CONGRATULATION! YOU WON FREE GIFT WITH THIS ORDER"
                }
              ],
              "sku": "Clubride - Roxbury - Char - S",
              "grams": 227,
              ...
              "final_price": 0,
              "final_line_price": 0,
              "url": "/products/roxbury-jersey?variant=12543438454867",
              "featured_image": {
                "aspect_ratio": 1.5,
                "alt": "Club Ride Roxbury Jersey",
                "height": 800,
                "url": "https://cdn.shopify.com/s/files/1/2325/8929/products/roxbury-charcoal.jpg?v=1569177889",
                "width": 1200
              },
              "image": "https://cdn.shopify.com/s/files/1/2325/8929/products/roxbury-charcoal.jpg?v=1569177889",
              "handle": "roxbury-jersey",
              "requires_shipping": true,
              "product_type": "Apparel",
              "product_title": "Club Ride Roxbury Jersey",
              "product_description": "This is a demonstration store. You can purchase products like this from Pure Fix CyclesOnce you spend a day in the Roxbury, you'll probably want to spend the night too.  Made with cutting edge RideDryWear, it'll keep you dry on the hottest rides and in the coolest clubs.  The Roxbury also has reflective accents to keep you safe on the road and help you get the attention you deserve off of it.  Couple all that with the Roxbury's rear-pocket media port and you've got a stylish shirt that'll let you keep your tunes bumpin' and your head bobbin' all night long!",
              "variant_title": "S",
              "variant_options": [
                "S"
              ],
              ...
              "line_level_discount_allocations": [
                {
                  ...
                  "discount_application": {
                    "type": "script",
                    "key": "b7f26325-d525-40aa-9e6a-c1fc4488d421",
                    "title": "CONGRATULATION! YOU WON FREE GIFT WITH THIS ORDER",
                    "description": null,
                    "value": "91.34",
                    "created_at": "2020-05-31T06:57:37.303Z",
                    "value_type": "fixed_amount",
                    "allocation_method": "across",
                    "target_selection": "explicit",
                    "target_type": "line_item",
                    "total_allocated_amount": 70800
                  }
                }
              ],
              "line_level_total_discount": 70800
            },
            {
              "id": 12543449890899,
              "properties": {},
...
4. cart_final
    ...
    This is the final cart data after applying all the filters. This is the opportunity to modify any of the data before cart drawer is built. You can also use this filter to inspect what variables will be available in `Cart Drawer Theme` templates.
    ...
    - Toggle `cart` argument data
        ...
        ```json
        {
          ...
          "items": [
            {
              ...
              "line_level_discount_allocations": [
                {
                  ...
                  "discount_application": {
                    "type": "script",
                    "key": "39cbe3cb-53c3-4dd9-892a-eee345e606f0",
                    "title": "CONGRATULATION! YOU WON FREE GIFT WITH THIS ORDER",
                    "description": null,
                    "value": "91.34",
                    "created_at": "2020-05-31T07:00:35.148Z",
                    "value_type": "fixed_amount",
                    "allocation_method": "across",
                    "target_selection": "explicit",
                    "target_type": "line_item",
              ...
              "line_level_total_discount": 70800,
              "line": 1,
              "img": "https://cdn.shopify.com/s/files/1/2325/8929/products/roxbury-charcoal_large.jpg?v=1569177889",
              "name": "Club Ride Roxbury Jersey",
              "variation": "S",
              "original_properties": {
                "__ucd": "Tiered Free Items"
              },
              ...
              "itemQty": 1,
              "price_formatted": "$708.00",
              "original_price_formatted": "$708.00",
              "discounted_price_formatted": "$0.00",
              "linePrice": "$0.00",
              "line_price_formatted": "$0.00",
              "original_line_price_formatted": "$708.00",
              "total_discount_formatted": "$708.00",
              "final_price_formatted": "$0.00",
              "final_line_price_formatted": "$0.00",
              "originalPrice": "$708.00",
          ...
          "original_total_price_formatted": "$3,297.00",
          "items_subtotal_price_formatted": "$2,589.00",
          "totalCartDiscount": "$708.00",
          "total_discount_formatted": "$708.00",
          "totalCartDiscountApplied": true,
          "special_offers": {
            "tiers": [
              {
...
5. recommended_products
    ...
    This filter can be used to see/edit the automatic recommended products suggestions for current cart.
...
6. upsells
    ...
    This filter can be used to see/edit the upsells products suggestions for current cart.
...
7. tiered_free_items
    ...
    This filter can be used to see/edit the tiered free items for current cart.
...
8. special_offer_notification

    ```jsx
    sellify.ucd.filters.special_offer_notification.push(function(messages){
    	return messages;
    });
    ```

    - Toggle `messages` argument data
...
9. cart_submit
    ...
    This filter can be used to perform an action when the `Checkout button` is clicked or checkout form is submitted. `e` argument is the original jQuery event you can use to prevent the submission or perform your desired action.
    ...
    - Toggle `e` argument data
        ...
        ```json
        {
          ...
          "timeStamp": 205746.13999999565,
          "jQuery350008714694842682325": true,
          "delegateTarget": {
            "location": {
              "href": "https://demo.sellify.dev/",
              "ancestorOrigins": {},
              "origin": "https://demo.sellify.dev",
              "protocol": "https:",
              "host": "demo.sellify.dev",
              "hostname": "demo.sellify.dev",
              "port": "",
              "pathname": "/",
              "search": "",
              "hash": ""
            ...
            "jQuery223079830249495963471": {
              "events": {
                ...
                "shopify:section:unload": [
                  {
                    ...
                    "origType": "shopify:section:unload",
                    "guid": 2,
                    "namespace": ""
                  }
                ],
                "shopify:section:select": [
                  {
                    ...
                    "origType": "shopify:section:select",
                    "guid": 3,
                    "namespace": ""
                  }
                ],
                "shopify:section:deselect": [
                  {
                    ...
                    "origType": "shopify:section:deselect",
                    "guid": 4,
                    "namespace": ""
                  }
                ],
                ...
                "shopify:block:deselect": [
                  {
                    ...
                    "origType": "shopify:block:deselect",
                    "guid": 6,
                    "namespace": ""
                  }
                ],
                "webkitvisibilitychange": [
                  {
                    ...
                    "origType": "webkitvisibilitychange",
                    "guid": 26,
                    "namespace": ""
                  }
                ],
                "submit": [
                  {
                    ...
                    "origType": "submit",
                    "guid": 37,
                    "selector": "form.sellify-ucd-cart-form,form[action^=\"/cart/add\"], form[action$=\"/cart/add\"]",
                    "needsContext": false,
                    "namespace": ""
                  }
                ],
                "click": [
                  {
                    ...
                    "origType": "click",
                    "guid": 38,
                    "selector": "form.sellify-ucd-cart-form [type=\"submit\"],form[action^=\"/cart/add\"] [type=\"submit\"],form[action$=\"/cart/add\"] [type=\"submit\"]",
                    "needsContext": false,
                    "namespace": ""
                  },
                  {
                    ...
                    "origType": "click",
                    "guid": 40,
                    "selector": "a[href=\"/cart\"]:not([data-ucd=\"0\"]), a[href$=\"/cart\"]:not([data-ucd=\"0\"]),a[href=\"/cart\"]:not([data-ucd=\"0\"]), a[href^=\"/cart\"]:not([data-ucd=\"0\"]):not([href*=\"quantity\"]), a[href^=\"/cart\"]:not([data-ucd=\"0\"]):not([href*=\"quantity\"]), .open-drawer",
                    "needsContext": false,
                    "namespace": ""
                  },
                  {
                    ...
                    "origType": "click",
                    "guid": 47,
                    "selector": ".sellify-ucc-selector",
                    "needsContext": false,
                    "namespace": "sellify-ucc-select"
                  },
                  {
                    "type": "click",
                    "origType": "click",
                    "guid": 48,
                    "selector": ".sellify-ucc-selector .sellify-ucc-list-option",
                    "needsContext": false,
                    "namespace": "sellify-ucc-select"
                  }
                ],
                ...
                "focusin": [
                  {
                    ...
                    "origType": "focus",
                    "guid": 50,
                    "selector": ".sellify-ucc-selector input[type='search']:visible",
                    "needsContext": false,
                    "namespace": ""
                  }
                ],
                ...
                "ajaxComplete": [
                  {
                    "type": "ajaxComplete",
                    "origType": "ajaxComplete",
                    "data": null,
                    "guid": 52,
                    "namespace": "sellify-ucc"
                  }
                ],
                "mouseover": [
                  {
                    ...
                    "origType": "mouseenter",
                    "guid": 53,
                    "selector": ".money, [itemprop=\"price\"], .product-single__price, #ProductPrice, #ComparePrice, .price-item",
                    "needsContext": false,
                    "namespace": ""
                  }
                ],
                ...
                "click": [
                  {
                    ...
                    "origType": "click",
                    "guid": 2,
                    "selector": ".ucdcart__qty-adjust, .ucd-qty-adjust",
                    "needsContext": false,
                    "namespace": ""
                  },
                  {
                  ...
                  },
                  {
                    ...
                    "origType": "click",
                    "guid": 9,
                    "selector": ".ucd-drawer__close, .ucd-drawer__close *, .close-drawer",
                    "needsContext": false,
                    "namespace": ""
                  },
                  {
                    ...
                    "origType": "click",
                    "guid": 12,
                    "selector": ".sellify-ucd-apply-discount-code",
                    "needsContext": false,
                    "namespace": ""
                  },
                  {
                    ...
                    "origType": "click",
                    "guid": 13,
                    "selector": ".sellify-ucd-remove-discount-code",
                    "needsContext": false,
                    "namespace": ""
                  }
                ],
                "change": [
                  {
                    ...
                    "origType": "change",
                    "guid": 3,
                    "selector": ".sellify-ucd-drawer .ucdcart__qty-num, .sellify-ucd-drawer [name=\"updates[]\"]",
                    "needsContext": false,
                    "namespace": ""
                  },
                  {
                    ...
                    "origType": "change",
                    "guid": 7,
                    "selector": ".sellify-ucd-drawer textarea[name=\"note\"]",
                    "needsContext": false,
                    "namespace": ""
                  },
                  {
                    ...
                    "origType": "change",
                    "guid": 10,
                    "selector": "#sellify-ucd-cart-drawer select[name=\"id\"]",
                    "needsContext": false,
                    "namespace": ""
                  }
                ],
...
10. hide_product
    ...
    `hide_product` filter is described in details here:

    [How do I hide certain products from being suggested in Upsells/Automatic Recommendations?](How%20do%20I%20hide%20certain%20products%20from%20being%20suggeste%20b6ab8478d28a4520969c0dd8519f742d.md)